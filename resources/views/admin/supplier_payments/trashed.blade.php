...
@section('title', __('global.supplier_payments'). __('global.deleted'))

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{__('global.supplier_payments'). __('global.deleted')}}</h1>
            @can('supplier_list')
                <a href="{{route('admin.supplier-payments.index')}}" class="btn btn-primary mt-2">{{__('global.go_back')}}</a>
            @endcan
                            ...
                            @foreach($supplier_payments as $supplier_payment)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{route('admin.supplier-payments.restore',['supplier_payment'=>$supplier_payment->id])}}"  class="btn btn-success btn-sm px-1 py-0"><i class="fa fa-arrow-left"></i></a>
                                        <a href="{{route('admin.supplier-payments.force_delete',['supplier_payment'=>$supplier_payment->id])}}"  class="btn btn-danger btn-sm px-1 py-0"><i class="fa fa-trash"></i></a>
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
