                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select id="type" name="type"  class="form-control">
                                        <option value="payment" @if($supplier_payment->type == 'payment') selected @endif>{{__('global.payment')}}</option>
                                        <option value="return" @if($supplier_payment->type == 'return') selected @endif>{{__('global.return')}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="amount" min="1" name="amount" step="any" value="{{$supplier_payment->amount}}" type="number" class="form-control" placeholder="{{ __('global.enter_supplier_payment')}}">
                                </div>
                            </div>
