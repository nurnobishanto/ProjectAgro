...
@section('title', __('global.create_purchase'))

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{ __('global.create_purchase')}}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{ __('global.home')}}</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.purchases.index')}}">{{ __('global.purchases')}}</a></li>
                <li class="breadcrumb-item active">{{ __('global.create_purchase')}}</li>
            </ol>
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.purchases.store')}}" method="POST" enctype="multipart/form-data" id="admin-form">
                        @csrf
                        @if (count($errors) > 0)
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input id="invoice_no" name="invoice_no" value="{{generateInvoiceId('PINV',\App\Models\Purchase::class)}}" class="form-control" placeholder="{{ __('global.invoice_no')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label for="purchase_date">{{ __('global.purchase_date')}}<span class="text-danger">*</span></label>
                                            <input id="purchase_date" name="purchase_date" type="text" class="datepicker form-control" placeholder="{{ __('global.purchase_date')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input  id="shipping_cost" type="number" value="" class="form-control" name="shipping_cost" placeholder="{{__('global.shipping_cost')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label for="labor_cost" class="form-label">{{__('global.labor_cost')}}</label>
                                            <input  id="labor_cost" type="number" value="" class="form-control" name="labor_cost" placeholder="{{__('global.labor_cost')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label for="other_cost" class="form-label">{{__('global.other_cost')}}</label>
                                            <input  id="other_cost" type="number" value="" class="form-control" name="other_cost" placeholder="{{__('global.other_cost')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="purchase_note" name="purchase_note" class="form-control" placeholder="{{ __('global.enter_purchase_note')}}"></textarea>
                                        </div>
                                    </div>
