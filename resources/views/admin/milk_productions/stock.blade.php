                ...
                <div class="card">
                    <div class="card-header">
                        <form class="" action="" method="get">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="btn btn-secondary" readonly value="{{__('global.total')}} : {{$total}} {{__('global.ltr')}}">
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="card-body table-responsive">
                        <table id="stockList" class="table  dataTable table-bordered table-striped">
                            <thead>
                            <tr>
                                <th width="100px">{{__('global.sl')}}</th>
                            ...
                            @foreach($milk_stocks as $stock)
                                <tr>
                                    ...
                                    <td>{{$stock->quantity}} <sup>{{__('global.ltr')}}</sup></td>
