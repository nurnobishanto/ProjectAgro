...
@section('title', __('global.create_party_receive'))

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{ __('global.create_party_receive')}}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{ __('global.home')}}</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.party-receives.index')}}">{{ __('global.party_receives')}}</a></li>
                <li class="breadcrumb-item active">{{ __('global.create_party_receive')}}</li>
            </ol>
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.party-receives.store')}}" method="POST" enctype="multipart/form-data" id="admin-form">
                        @csrf
                        @if (count($errors) > 0)
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="unique_id" readonly value="{{generateInvoiceId('PR',\App\Models\PartyReceive::class,'unique_id')}}" id="unique_id"  type="text" class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <div class="form-group">
                                    <label for="amount">{{ __('global.received_amount')}}<span class="text-danger"> *</span></label>
                                    <input id="amount" name="amount" type="number" class="form-control" placeholder="{{ __('global.enter_received_amount')}}">
                                </div>
                            </div>
