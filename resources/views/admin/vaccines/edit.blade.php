...
@section('title', __('global.update_vaccine'))

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{ __('global.update_vaccine')}}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{ __('global.home')}}</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.vaccines.index')}}">{{ __('global.vaccines')}}</a></li>
                <li class="breadcrumb-item active">{{ __('global.update_vaccine')}}</li>
            </ol>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 shadow p-2"><strong>{{__('global.vaccine')}} :</strong> {{$product->name}}</div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{route('admin.vaccines.update',['vaccine'=>$vaccine->id])}}" method="POST" enctype="multipart/form-data" id="admin-form">
                        @method('PUT')
                        @csrf
                        @if (count($errors) > 0)
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form">
                                            ...
                                            <input readonly name="date" value="{{$vaccine->date}}" id="date"  type="text" class="form-control datepicker">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form">
                                            ...
                                            <input  name="time" id="time" value="{{$vaccine->time}}"  type="text" class="form-control" placeholder="{{ __('global.medicine_time')}}">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form">
                                            ...
                                            <input readonly name="end_date" value="{{$vaccine->end_date}}" id="end_date"  type="text" class="form-control datepicker">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="form">
                                                <label>{{ $product->name }} ({{ (getStock($farm->id, $product->id)->quantity ?? 0)+$vaccine->quantity }} {{ $product->unit->code }})</label>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form">
                                            ...
                                            <textarea name="comment" id="comment"  type="text" class="form-control">{{$vaccine->comment}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                @foreach($cattles as $cattle)
                                                    <tr>
                                                        <td><input type="checkbox" name="cattles[]" @if ($vaccine->cattles->contains($cattle->id)) checked @endif  value="{{$cattle->id}}" class="form-control form-check"></td>
                                                        <td>{{$cattle->tag_id}}</td>
