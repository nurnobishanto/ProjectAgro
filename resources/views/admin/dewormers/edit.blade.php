...
@section('title', __('global.update_dewormer'))

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{ __('global.update_dewormer')}}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{ __('global.home')}}</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.dewormers.index')}}">{{ __('global.dewormers')}}</a></li>
                <li class="breadcrumb-item active">{{ __('global.update_dewormer')}}</li>
            </ol>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.dewormers.update',['dewormer'=>$dewormer->id])}}" method="POST" enctype="multipart/form-data" id="admin-form">
                        @method('PUT')
                        @csrf
                        @if (count($errors) > 0)
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form">
                                            ...
                                            <input readonly name="date" value="{{$dewormer->date}}" id="date"  type="text" class="form-control datepicker">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form">
                                            ...
                                            <input  name="time" id="time" value="{{$dewormer->time}}"  type="text" class="form-control" placeholder="{{ __('global.medicine_time')}}">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form">
                                            ...
                                            <input readonly name="end_date" value="{{$dewormer->end_date}}" id="end_date"  type="text" class="form-control datepicker">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="form">
                                                <label>{{ $product->name }} ({{ (getStock($farm->id, $product->id)->quantity ?? 0)+$dewormer->quantity }} {{ $product->unit->code }})</label>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form">
                                            ...
                                            <textarea name="comment" id="comment"  type="text" class="form-control">{{$dewormer->comment}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                @foreach($cattles as $cattle)
                                                    <tr>
                                                        <td><input type="checkbox" name="cattles[]" @if ($dewormer->cattles->contains($cattle->id)) checked @endif  value="{{$cattle->id}}" class="form-control form-check"></td>
                                                        <td>{{$cattle->tag_id}}</td>
