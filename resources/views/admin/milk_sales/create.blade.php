...
@section('title', __('global.create_milk_sale'))

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{ __('global.create_milk_sale')}}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{ __('global.home')}}</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.milk-sales.index')}}">{{ __('global.milk_sales')}}</a></li>
                <li class="breadcrumb-item active">{{ __('global.create_milk_sale')}}</li>
            </ol>
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.milk-sales.store')}}" method="POST" enctype="multipart/form-data" id="admin-form">
                        @csrf
                        @if (count($errors) > 0)
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="d-none" name="farm_id" value="{{$farm_id}}">
                                            <input id="unique_id" name="unique_id" value="{{generateInvoiceId('MS',\App\Models\MilkSale::class,'unique_id')}}" class="form-control" placeholder="{{ __('global.unique_id')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label for="date">{{ __('global.date')}}<span class="text-danger">*</span></label>
                                            <input id="date" name="date" type="text" class="datepicker form-control" placeholder="{{ __('global.date')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="milk_sale_party_id" class="select2 form-control" id="milk_sale_party_id">
                                                ...
                                                @foreach(getMilkSaleParty() as $milk_sale_party)
                                                    <option value="{{ $milk_sale_party->id }}" >{{ $milk_sale_party->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input  id="quantity" type="number" step="any" max="{{$stock->quantity??0}}" min="0.0001"  class="form-control" name="quantity" placeholder="{{__('global.milk_quantity')}}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-12">
                                        <div class="form-group">
                                            <label for="unit_price" class="form-label">{{__('global.unit_price')}}<span class="text-danger"> *</span></label>
                                            <input  id="unit_price" type="number" step="any" value="" class="form-control" name="unit_price" placeholder="{{__('global.unit_price')}}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-12">
                                        <div class="form-group">
