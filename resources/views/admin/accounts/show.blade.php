...
@section('title', __('global.view_account'))

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{__('global.view_account')}} - {{$account->name}}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('global.home')}}</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.accounts.index')}}">{{__('global.accounts')}}</a></li>
                <li class="breadcrumb-item active">{{__('global.view_account')}}</li>
            </ol>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="admin">{{ __('global.admin')}}</label>
                                        <input id="admin" class="form-control" disabled value="{{$account->admin->name??'--'}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="bank_name">{{ __('global.bank_name')}}</label>
                                        <input id="bank_name" class="form-control" disabled value="{{$account->bank_name}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="account_name">{{ __('global.account_name')}}</label>
                                        <input id="account_name" class="form-control" disabled value="{{$account->account_name}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="account_no">{{ __('global.account_no')}}</label>
                                        <input id="account_no" class="form-control" disabled value="{{$account->account_no}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="account_type">{{ __('global.account_type')}}</label>
                                        <input id="account_type" class="form-control" disabled value="{{__('global.'.$account->account_type)}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="status">{{ __('global.status')}}</label>
                                        <input id="status" class="form-control" disabled value="{{__('global.'.$account->status)}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="current_balance">{{ __('global.current_balance')}}</label>
                                        <input id="current_balance" class="form-control" disabled value="{{$account->current_balance}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="updated_by">{{ __('global.updated_by')}}</label>
                                        <input id="updated_by" class="form-control" disabled value="{{$account->updatedBy->name}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="created_by">{{ __('global.created_by')}}</label>
                                        <input id="created_by" class="form-control" disabled value="{{$account->createdBy->name}}">
                                    </div>
                                </div>
