...
@section('title', __('global.create_account'))

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{ __('global.create_account')}}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{ __('global.home')}}</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.accounts.index')}}">{{ __('global.accounts')}}</a></li>
                <li class="breadcrumb-item active">{{ __('global.create_account')}}</li>
            </ol>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="bank_name" name="bank_name" class="form-control" value="{{old('bank_name')}}" placeholder="{{ __('global.enter_bank_name')}}">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="form-group">
                                    <label for="account_name">{{ __('global.account_name')}} <span class="text-danger"> *</span></label>
                                    <input id="account_name" name="account_name" class="form-control" value="{{old('account_name')}}" placeholder="{{ __('global.enter_account_name')}}">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="form-group">
                                    <label for="account_no">{{ __('global.account_no')}} <span class="text-danger"> *</span></label>
                                    <input id="account_no" name="account_no" class="form-control" value="{{old('account_no')}}" placeholder="{{ __('global.enter_account_no')}}">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="form-group">
