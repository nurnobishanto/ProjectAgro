...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{__('global.accounts')}}</h1>
            @can('account_create')
                <a href="{{route('admin.accounts.create')}}" class="btn btn-primary mt-2">{{__('global.add_new')}}</a>
            @endcan
            @can('account_delete')
                <a href="{{route('admin.accounts.trashed')}}" class="btn btn-danger mt-2">{{__('global.trash_list')}}</a>
            @endcan
