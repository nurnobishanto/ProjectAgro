...
@section('title', __('global.supplier_payment_report'))

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{__('global.supplier_payment_report')}}</h1>
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">{{__('global.supplier_payment_report')}}</li>
            </ol>
...
@section('content')
    <div class="row">
        ...
        {{--            <div class="card">--}}
        {{--                <div class="card-body">--}}
        {{--                    <form action="{{route('report.cattle.staff_salary_report')}}" method="GET">--}}
