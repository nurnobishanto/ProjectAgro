                    ...
                    <div class="card-body table-responsive">
                        <table id="adminsList" class="table  dataTable table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th>{{__('global.purchase')}}</th>
                                <th>{{__('global.feeding')}}</th>
                                <th>{{__('global.dewormer')}}</th>
                                <th>{{__('global.vaccine')}}</th>
                                <th>{{__('global.treatment')}}</th>
                                <th>{{__('global.avg_other_cost')}}</th>
                                <th>{{__('global.total')}}</th>
                            </thead>
                            <tbody>
                            @foreach($cattles as $cattle)
                                @php $cattleCost = getCattleTotalCost($cattle) @endphp
                                <tr>
                                    <td>{{$cattle->tag_id??'--'}} </td>
                                    <td>{{getSetting('currency')}} {{$cattleCost['purchase_price']}}</td>
                                    <td>{{getSetting('currency')}} {{$cattleCost['feeding_cost']}}</td>
                                    <td>{{getSetting('currency')}} {{$cattleCost['dewormer_cost']}}</td>
                                    <td>{{getSetting('currency')}} {{$cattleCost['vaccine_cost']}}</td>
                                    <td>{{getSetting('currency')}} {{$cattleCost['treatment_cost']}}</td>
                                    <td>{{getSetting('currency')}} {{$cattleCost['avg_other_cost']}}</td>
                                    <td>{{getSetting('currency')}} {{$cattleCost['grand_total']}}</td>
